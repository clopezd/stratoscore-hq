...
-- 2. Copiar TODO este archivo y pegar en el editor SQL
...
-- Tablas creadas:
--   • terapeutas
--   • equipos (con 3 Lokomat iniciales)
--   • pacientes
--   • citas
--   • leads_mobility
--   • horarios_centro (Lun-Vie 8-18h, Sáb 8-13h)
--
-- Vistas creadas:
--   • ocupacion_diaria
--   • pacientes_proximo_vencimiento
--
-- Automatizaciones:
--   • Trigger: actualizar_sesiones_paciente (al completar cita)
--
-- Seguridad:
--   • RLS habilitado en todas las tablas
--   • Solo admin/operador tiene acceso
--
-- Próximo paso:
--   • Abrir http://localhost:3000/mobility
-- ============================================================
