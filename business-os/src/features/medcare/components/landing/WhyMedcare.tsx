    ...
    <section className="relative bg-gradient-to-b from-white via-[#FEEBF5]/30 to-white py-12 sm:py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-[#0F1820] text-center mb-3 tracking-tight">
          Por qué hacerse su mamografía en MEDCARE
        </h2>
          ...
          {[
            {
              ...
              desc: 'Si su mamografía detecta algo, la resonancia magnética, la biopsia y su especialista están bajo el mismo techo.',
              icon: (
            ...
            },
            {
              ...
              desc: 'Agende hoy, haga el estudio esta semana. Resultados el mismo día. Horario amplio L-V 6am-10pm, sábados, domingos y feriados.',
              icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
