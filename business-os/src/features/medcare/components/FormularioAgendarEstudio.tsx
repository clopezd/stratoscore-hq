              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <h4 className="text-lg font-bold text-gray-900 group-hover:text-slate-700">Ultrasonido Mamario</h4>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-green-800">
                        {esPromo ? 'Promo: Mamografía + US Mamario — ₡65,000' : (servicioSeleccionado?.nombre || (tipoSeleccionado === 'mamografia' ? 'Mamografía — ₡35,000' : 'Ultrasonido Mamario — ₡49,000'))}
                      </p>
