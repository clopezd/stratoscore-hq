  ...
  return (
    <form action={handleSubmit} className="space-y-5">
      ...
      <button
        type="submit"
        disabled={loading}
        className="relative w-full overflow-hidden rounded-2xl px-8 py-3.5 bg-[#1A1A1A] text-white font-semibold text-sm tracking-wide border border-white/[0.12] shadow-[0_1px_2px_rgba(0,0,0,0.2),0_4px_12px_rgba(0,0,0,0.3)] transition-all duration-300 hover:bg-[#2A2A2A] hover:border-white/[0.2] hover:shadow-[0_2px_4px_rgba(0,0,0,0.3),0_8px_20px_rgba(0,0,0,0.4)] active:scale-[0.98] disabled:opacity-40 disabled:pointer-events-none"
      >
