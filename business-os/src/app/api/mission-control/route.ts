...
export async function GET() {
  ...
  try {
    ...
    // Hardcoded clients usando rutas reales de la aplicación
    const clients: Client[] = [
      {
        ...
        primary_metric_label: 'REVENUE (MTD)',
        primary_metric_value: '$125,000',
      ...
      },
      {
        ...
        primary_metric_label: 'PACIENTES ACTIVOS',
      ...
      },
      {
        ...
        primary_metric_label: 'ORDENES HOY',
        primary_metric_value: '24',
      ...
      },
      {
        ...
        primary_metric_label: 'PROYECTO',
        primary_metric_value: 'Fase de propuesta',
        secondary_metric_label: null,
        secondary_metric_value: null,
        alerts_count: 0,
        tasks_count: 3,
