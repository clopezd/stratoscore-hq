...
import { Tags, Bot, Calculator, Wallet, Loader2 } from 'lucide-react'
...
import { AccountsManager } from '@/features/admin/components/AccountsManager'

type TabId = 'categories' | 'agent' | 'calculator' | 'accounts'
...
const TABS: Tab[] = [
  ...
  { id: 'accounts', label: 'Cuentas', icon: <Wallet className="w-4 h-4" /> },
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'accounts':
        return (
          <AccountsManager
            accounts={config.custom_accounts}
